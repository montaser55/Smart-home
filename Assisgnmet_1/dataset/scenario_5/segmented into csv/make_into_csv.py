...
def process_segment(segment_file, device_mac, directory_name, coordinator_mac="0x0000"):
    ...
    location = "../../../output/"
    scenario = f'scenario_5/{directory_name}/'
...
for index in range(1, 49):
    ...
    process_segment(f'../segmented packets/motionsensor_segment_{index}.pcapng', "0xdd43", "motionsensor")
    process_segment(f'../segmented packets/osarm_segment_{index}.pcapng', "0x8b7c","osarm")
    process_segment(f'../segmented packets/outdoormotionsensor_segment_{index}.pcapng', "0x6ef9","outdoormotionsensor")