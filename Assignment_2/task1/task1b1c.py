...
def process_inter_arrival_times(packet, device_addresses, previous_timestamps, inter_arrival_times):
...
for packet in capture:
    try:
        ...
        process_inter_arrival_times(packet, device_addresses, previous_timestamps, inter_arrival_times)
...
# plot CDFs and CCDFs for inter arrival times, packet sizes by protocol and combined
