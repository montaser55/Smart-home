...
parser.add_argument('--base_directory', type=str, default="../pcap", help="Base directory containing the PCAP files.")
...
parser.add_argument('--output_file', type=str, default="../output/task_1a_analysis_results.txt", help="Path to the output file.")
